        ...
        "/posts/": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Konten teks postingan",
                        "name": "content",
                        "in": "formData"
                    },
                    {
                        "type": "file",
                        "description": "File gambar (jpg, png, dll)",
                        "name": "image",
                        "in": "formData"
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Format data tidak valid / konten kosong",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "500": {
                        "description": "Server error / gagal simpan file / DB",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
